...
function Find_Uncommon(Array1, Array2) {
    return Array1.filter(item => !Array2.includes(item));
}
function Find_Common(Array1, Array2) {
    return Array1.filter(item1 => Array2.includes(item1));
}
function Answer_Checker(Array1) {
    if (Array1.length == 1) {
...
let water_exceptions = ["Goldeen", "Staryu", "Psyduck", "Squirtle", "Poliwag", "Horsea", "Magikarp", "Seel", "Krabby", "Shellder"];
let bird_exceptions = ["Pidgey", "Spearow", "Doduo", "Farfetch'd"];
let fire_exceptions = ["Growlithe", "Vulpix", "Charmander", "Flareon", "Ponyta"];
let fighting_exceptions = ["Hitmonchan", "Hitmontop", "Mankey", "Machop"];
let normal2_exceptions = ["Meowth", "Chansey", "Kangaskhan", "Porygon", "Snorlax", "Lickitung"];
let psychic_exceptions = ["Abra", "Drowzee", "Mewtwo", "Mew"];
let grass_exceptions = ["Bellsprout", "Oddish"];
let rock_exceptions = ["Geodude", "Onix"];
let normal4_exceptions = ["Tauros", "Eevee"];
let posion_exceptions = ["Ekans", "Koffing", "Grimer"];
let bugpoison_exceptions = ["Kakuna", "Venomoth"];
let poison_male_female_exception = ["Nidoran♂", "Nidoran♀"];
